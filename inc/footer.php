...
<footer class="row flex-wrap justify-content-between align-items-center py-2 my-3 border-top mb-0 <?= (isset($_SESSION['USER']) && isset($_COOKIE["whiteTheme"]) && $_COOKIE["whiteTheme"] == "on") ? "bg-light"  : "bg-dark" ?>">
